...
#plate number
				...
				c1=(c-a)/2+c
				c2=(b+f)/2
				color= color_fun.get_colour_name(color_fun.get_rgb(infile,c1,c2))
...
+plate3+" Event Type: Illegal Parking' "+infile+" -fill yellow -pointsize 50 -geometry +0+0 -background Black "+infile)
					#break
